          ...
          <div className="flex items-center gap-4">
            {
              token && user ? (
              <div>
              <Link to={`${role==='mentor' ? '/mentors/profile/me' : '/users/profile/me'}`}>
                <figure className="w-[35px] h-[35px] rounded-full justify-center cursor-pointer">
                  <img src={prof} className="w-full rounded-full " alt="" />
                </figure>
              </Link> 
          </div>) : (<Link to="/login">
