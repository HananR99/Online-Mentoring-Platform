...
import mentorImage from '../../assets/images/mentor-img02.png';
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-5">
              <figure className='max-w-[200px] max-h-[200px]'>
                <img src={mentorImage} alt='' className='w-full'/>
              </figure>
              ...
              <div>
                ...
                <p className="text_para text-[14px] leading-6 md:text-[15px] lg:max-w-[390px]">
                  Licensed Professional Counselor at Thrive Behavioral Netwrok, LLC.
                </p>
              </div>
            </div>
